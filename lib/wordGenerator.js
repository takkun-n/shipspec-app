...
async function generateWord(d) {
  ...
  children.push(
    ...
    emptyP(),
    h3('■ 配管仕様一覧'),
    new Table({width:{size:CW,type:WidthType.DXA}, columnWidths:[1800,1100,1700,900,900,2346], rows:[
      new TableRow({children:[hCell('名称',1800),hCell('寸法',1100),hCell('材質・規格',1700),hCell('溶融浸せき',900),hCell('電気メッキ',900),hCell('施工場所・備考',2346)]}),
      ...formRowsToTableRows(d.pipeRows||[],[1800,1100,1700,900,900,2346]),
    ]}),
    emptyP(),
  );
  ...
  children.push(
    ...
    new Table({width:{size:CW,type:WidthType.DXA}, columnWidths:[2200,2200,800,1200,1800,1546], rows:[
      ...
      ...formRowsToTableRows(d.stairRows||[],[2200,2200,800,1200,1800,1546]),
    ]}),
    emptyP(),
    h3('■ ハンドレール・スタンション'),
    new Table({width:{size:CW,type:WidthType.DXA}, columnWidths:[2200,1800,1500,1500,1100,1646], rows:[
      new TableRow({children:[hCell('区分',2200),hCell('位置',1800),hCell('トップレール',1500),hCell('スタンション',1500),hCell('横棒',1100),hCell('備考',1646)]}),
      ...formRowsToTableRows(d.handrailRows||[],[2200,1800,1500,1500,1100,1646]),
    ]}),
    emptyP(),
    new Table({width:{size:CW,type:WidthType.DXA}, columnWidths:[3000,6746], rows:[
      row2('ワーフラダー','6.0m × 1（軽合金製・幅600㎜）',3000,6746),
      row2('グレーチング','縞鋼板製グレーチング（機関室内必要箇所）',3000,6746),
      row2('ストームレール','操舵室・便所等必要箇所にクロームメッキ製ストームレールを設ける。',3000,6746),
    ]}),
    emptyP(),
  );
  ...
  children.push(
    ...
    new Table({width:{size:CW,type:WidthType.DXA}, columnWidths:[2800,2000,2000,900,2046], rows:[
      new TableRow({children:[hCell('塗装箇所',2800),hCell('下塗・塗料（回数・膜厚）',2000),hCell('仕上塗料（回数・膜厚）',2000),hCell('回数',900),hCell('メーカー・備考',2046)]}),
      ...formRowsToTableRows(d.paintRows||[],[2800,2000,2000,900,2046]),
    ]}),
    emptyP(),
  );
